function [status, dat, e, fitme, esf, nbin, del2] = sfrmat4(io, del, npol, weight, a)
%******************************************************************
...
%     cc = zeros(nlin, npix*1);
%     cc = [  lum];
%     cc = reshape(cc,nlin,npix,1);
% 
%     a = cc;
%     clear cc;
%     clear lum;
...
%            set(get(h,'title'),'String',['mtf50 = ',num2str(mtf50)]);             
